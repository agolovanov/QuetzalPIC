...
double array_to_particle(double y, double z, const array3d & array, int slice, double yshift=0.0, double zshift=0.0);
double array_to_particle(double y, double z, const array2d & array, double yshift=0.0, double zshift=0.0);
